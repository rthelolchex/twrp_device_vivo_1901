...
# Kernel
BOARD_KERNEL_CMDLINE := bootopt=64S3,32N2,64N2 product.version=PD1901BF_EX_A_6.12.18 fingerprint.abbr=11/RP1A.200720.012 buildvariant=user
...
TARGET_KERNEL_SOURCE := kernel/vivo/1901
TARGET_KERNEL_CONFIG := 1901_defconfig
